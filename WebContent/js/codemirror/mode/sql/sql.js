...
(function() {
  ...
  var sqlKeywords = "alter inner and as asc between group by count create delete desc distinct drop from having in insert into is join like not on or order select set table union update values where ";
